            ...
            <div class="column block">
                ...
                <div>
                    <div class="home-content">
                        ...
                        <img src="{{URL::asset('assets/assets/themes/Gob/images/Bangabandhu-.jpg')}}" alt="" style="100%"/>
                        <p>
                    ...
                    <button type="button" ng-click="showDetail()">Read more</button>
                    </div>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="select-style">
                                    <select class="form-control  ha-dbbl" ng-disabled="!advanceSearchData.DistrictId" ng-model="advanceSearchData.ThanaId" ng-options="item.id as item.name for item in thanaList" id="ThanaId" name="Thana" ng-change="getPoliceStation()">
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="select-style">
                                    <select class="form-control " ng-disabled="!advanceSearchData.ThanaId" ng-model="advanceSearchData.PoliceStationId" ng-options="item.id as item.name for item in policeStationList" id="PoliceStationId" name="PoliceStation" ng-change="getVillage()">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="select-style">
                                    <select class="form-control  ha-dbbl" ng-disabled="!advanceSearchData.PoliceStationId" ng-model="advanceSearchData.VillageId" ng-options="item.id as item.name for item in villageList" id="VillageId" name="Village" required tabindex="1">
