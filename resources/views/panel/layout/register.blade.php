                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group" show-errors>
                                        ...
                                        <div class="show-message">
                                            <input type="text" style="width: 100%" name="phone" class="form-control" only-numbers name="ContactNo" ng-model="registerModel.Phone" placeholder="Your contact no (contact no will be user name)" ng-blur="CheckUserAlreadyExist()" />
