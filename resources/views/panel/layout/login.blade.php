    ...
    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2" style="margin-top: 110px;margin-bottom: 119px;">
            <div class="sign-inner">
                ...
                <div class="error">
                    ...
                    <form action="{{route('attempt_login')}}" class="form-horizontal" method="post" autocomplete="off" novalidate>
                        @method('POST')
                        @csrf
                    ...
                    {{-- <button type="submit" name="submit"lass="ha-btn-small">প্রবেশ</button> --}}
                    </form>
            </div>
    </div>
</div>
