                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title">Add new motamot</h3>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form">
                                    <div class="form-group">
                                            <label for="title">Motamot Title:</label>
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input class="form-control" name="title" placeholder="Write something" ng-model="motamotPostOb.Title" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="post-item">
                                        <div class="post-title">
                                            <a class="col-sm-11" href="/motamot-management/@{{x.id}}">@{{x.title}}</a>
                                            <div class="dropdown col-sm-1" ng-show="x.UserId===globalUserInfo.UserId">
                                                <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">
                                                    ...
                                                </button>
                                                <ul class="dropdown-menu">
                                                    <li><a href="/motamotPost/EditAdminPost?id=@{{x.Id}}" title="edit post">Edit</a></li>
                                        ...
                                        <div class="post-row">
                                            ...
                                            <a href="/motamot-management/@{{x.id}}" class="btn btn-default btn-rounded pull-right">Read more &RightArrow;</a>
                                        </div>
