...
<html lang="en" ng-app="adminPanelApp">
    ...
    <script  type="text/javascript" src="{{asset('js/adminDashboard/categoryController.js')}}"></script>
    <script  type="text/javascript" src="{{asset('js/adminDashboard/advertiseController.js')}}"></script>
